            ...
            <div class="header__row row">
                <div class="header__column column column--2">
                    <h1 class="header__logo">
                        ...
                        <img src="<?= $logo['url'] ? $logo['url'] : get_template_directory_uri().'/dist/images/Bloggers-love-stickers_Logo.png'; ?>" alt="<?php $logo['alt'] ? $logo['alt'] : __('Bloggers love stickers', 'bls_theme'); ?>" class="header__logo-img">
                    </h1>
                </div>
                <div class="header__column column column--2 hide-mobile">
